...
(2, 'site_options', '{"site_name":"\\u73ab\\u7470\\u91cc","site_host":"http:\\/\\/www.lavin.com.cn","site_admin_url_password":"","site_tpl":"simplebootx","mobile_tpl_enabled":"1","site_adminstyle":"bluesky","site_icp":"","site_admin_email":"mindasiy@sina.com","site_tongji":"","site_copyright":"","site_seo_title":"","site_seo_keywords":" ","site_seo_description":" ","urlmode":"0","html_suffix":"","comment_time_interval":60,"site_bj_kf":"<SCRIPT LANGUAGE=\\"JavaScript\\" src=http:\\/\\/floatedu.tq.cn\\/floatcard?adminid=9795331&sort=0 ><\\/SCRIPT>","site_sh_kf":"<SCRIPT LANGUAGE=\\"JavaScript\\" src=http:\\/\\/floatedu.tq.cn\\/floatcard?adminid=9795331&sort=4 ><\\/SCRIPT>","site_tj_kf":"<SCRIPT LANGUAGE=\\"JavaScript\\" src=http:\\/\\/floatedu.tq.cn\\/floatcard?adminid=9795331&sort=3 ><\\/SCRIPT>","site_njwq_kf":"<SCRIPT LANGUAGE=\\"JavaScript\\" src=http:\\/\\/floatedu.tq.cn\\/floatcard?adminid=9795331&sort=2 ><\\/SCRIPT>","site_nj_kf":"<SCRIPT LANGUAGE=\\"JavaScript\\" src=http:\\/\\/floatedu.tq.cn\\/floatcard?adminid=9795331&sort=1 ><\\/SCRIPT>"}', 1),
(3, 'cmf_settings', '{"banned_usernames":""}', 1);

-- --------------------------------------------------------

--
-- 表的结构 `data_options_bak`
--

CREATE TABLE IF NOT EXISTS `data_options_bak` (
  `option_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `option_name` varchar(64) NOT NULL COMMENT '配置名',
  `option_value` longtext NOT NULL COMMENT '配置值',
  `autoload` int(2) NOT NULL DEFAULT '1' COMMENT '是否自动加载',
...
--
-- 转存表中的数据 `data_options_bak`
--

INSERT INTO `data_options_bak` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
(1, 'member_email_active', '{"title":"ThinkCMF\\u90ae\\u4ef6\\u6fc0\\u6d3b\\u901a\\u77e5.","template":"<p>\\u672c\\u90ae\\u4ef6\\u6765\\u81ea<a href=\\"http:\\/\\/www.thinkcmf.com\\">ThinkCMF<\\/a><br\\/><br\\/>&nbsp; &nbsp;<strong>---------------<\\/strong><br\\/>&nbsp; &nbsp;<strong>\\u5e10\\u53f7\\u6fc0\\u6d3b\\u8bf4\\u660e<\\/strong><br\\/>&nbsp; &nbsp;<strong>---------------<\\/strong><br\\/><br\\/>&nbsp; &nbsp; \\u5c0a\\u656c\\u7684<span style=\\"FONT-SIZE: 16px; FONT-FAMILY: Arial; COLOR: rgb(51,51,51); LINE-HEIGHT: 18px; BACKGROUND-COLOR: rgb(255,255,255)\\">#username#\\uff0c\\u60a8\\u597d\\u3002<\\/span>\\u5982\\u679c\\u60a8\\u662fThinkCMF\\u7684\\u65b0\\u7528\\u6237\\uff0c\\u6216\\u5728\\u4fee\\u6539\\u60a8\\u7684\\u6ce8\\u518cEmail\\u65f6\\u4f7f\\u7528\\u4e86\\u672c\\u5730\\u5740\\uff0c\\u6211\\u4eec\\u9700\\u8981\\u5bf9\\u60a8\\u7684\\u5730\\u5740\\u6709\\u6548\\u6027\\u8fdb\\u884c\\u9a8c\\u8bc1\\u4ee5\\u907f\\u514d\\u5783\\u573e\\u90ae\\u4ef6\\u6216\\u5730\\u5740\\u88ab\\u6ee5\\u7528\\u3002<br\\/>&nbsp; &nbsp; \\u60a8\\u53ea\\u9700\\u70b9\\u51fb\\u4e0b\\u9762\\u7684\\u94fe\\u63a5\\u5373\\u53ef\\u6fc0\\u6d3b\\u60a8\\u7684\\u5e10\\u53f7\\uff1a<br\\/>&nbsp; &nbsp; <a title=\\"\\" href=\\"http:\\/\\/#link#\\" target=\\"_self\\">http:\\/\\/#link#<\\/a><br\\/>&nbsp; &nbsp; (\\u5982\\u679c\\u4e0a\\u9762\\u4e0d\\u662f\\u94fe\\u63a5\\u5f62\\u5f0f\\uff0c\\u8bf7\\u5c06\\u8be5\\u5730\\u5740\\u624b\\u5de5\\u7c98\\u8d34\\u5230\\u6d4f\\u89c8\\u5668\\u5730\\u5740\\u680f\\u518d\\u8bbf\\u95ee)<br\\/>&nbsp; &nbsp; \\u611f\\u8c22\\u60a8\\u7684\\u8bbf\\u95ee\\uff0c\\u795d\\u60a8\\u4f7f\\u7528\\u6109\\u5feb\\uff01<br\\/><br\\/>&nbsp; &nbsp; \\u6b64\\u81f4<br\\/>&nbsp; &nbsp; ThinkCMF \\u7ba1\\u7406\\u56e2\\u961f.<\\/p>"}', 1),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Portal文章表' AUTO_INCREMENT=139 ;
...
(16, 1, '', '', '2018-05-15 22:21:18', '<p>2018年会钜惠</p>', '2018年会钜惠', '2018年会钜惠', 1, 1, '2018-05-15 22:20:20', NULL, 0, NULL, '', 0, '{"thumb":"20180910\\/5b95ce792fec9.jpeg"}', 7, 0, 0, 0, 0, '2018-09-10 00:00:00', '2018-12-31 00:00:00', '北京·太阳公元', '商务', '', '', '', '', '', ''),
...
(20, 1, '', '', '2018-06-06 13:07:20', '<p style="text-align: center;"><span style="font-size: 20px;"><br/></span></p><p><span style="font-size: 20px;"><br/></span></p><p style="text-align: center;"><span style="font-size: 20px;"><span style="font-size: 20px;"><img src="http://www.lavin.com.cn/data/upload/ueditor/20180907/5b91eb4dcc04f.png" title="list-hlcg-banner.png" alt="list-hlcg-banner.png"/></span></span></p><p><span style="font-size: 20px;"></span></p><p style="text-align: center;"><span style="font-size: 20px;"><br/></span></p><p style="text-align: center;"><span style="font-size: 20px;">①活动测试页面，内容无效。</span></p><p style="text-align: center;"><span style="font-size: 20px;"><br/></span></p><p style="text-align: center;"><span style="font-size: 20px;">当日前两对签单的新人赠送两桌星级婚宴；</span></p><p style="text-align: center;"><span style="font-size: 20px;"><br/></span></p><p style="text-align: center;"><span style="font-size: 20px;">②签订2018年淡季档期，赠送价值人民币5000元甜品台一套。</span></p>', '预定2018年婚礼档期，立享婚宴满1桌送1桌！', '预定2018年婚礼档期，立享婚宴满5桌送1桌！', 1, 1, '2018-09-07 00:00:00', NULL, 0, NULL, '', 0, '{"thumb":"20180910\\/5b95ce0f68400.jpeg"}', 35, 0, 0, 0, 0, '2018-09-07 00:00:00', '2018-09-15 00:00:00', '北京·太阳公元', '婚礼', '', '', '', '', '', '');
INSERT INTO `data_posts` (`id`, `post_author`, `post_keywords`, `post_source`, `post_date`, `post_content`, `post_title`, `post_excerpt`, `post_status`, `comment_status`, `post_modified`, `post_content_filtered`, `post_parent`, `post_type`, `post_mime_type`, `comment_count`, `smeta`, `post_hits`, `post_like`, `istop`, `recommended`, `newarc`, `actstarttime`, `actendtime`, `postadderss`, `type`, `max`, `tinggao`, `zhuoshu`, `tese`, `youhui`, `jiage`) VALUES
...
(47, 1, '', '', '2018-08-27 13:22:20', '<p style="text-align: center;"><span style="font-size: 18px;">经典法式宫殿设计，</span></p><p style="text-align: center;"><span style="font-size: 18px;">高大通透的宴会空间，</span></p><p style="text-align: center;"><span style="font-size: 18px;"> 独具风格的挑高穹顶，</span></p><p style="text-align: center;"><span style="font-size: 18px;">配有经典复古的水晶 吊灯。</span></p><p style="text-align: center;"><span style="font-size: 18px;">百万级定光音响设备，</span></p><p style="text-align: center;"><span style="font-size: 18px;">呈现梦幻多彩 的光影视听盛宴。</span></p><p style="text-align: center;"><span style="font-size: 18px;">超大弧形 LED 大屏幕，</span></p><p style="text-align: center;"><span style="font-size: 18px;"> 丰富商务活动立体体验。<br/></span></p><p><br/></p><p style="text-align: center"><img src="http://www.lavin.com.cn/data/upload/ueditor/20180906/5b914cfecff32.jpg" style="" title="WechatIMG39.jpg"/></p><p style="text-align: center"><img src="http://www.lavin.com.cn/data/upload/ueditor/20180906/5b914cff519b4.jpg" style="" title="WechatIMG40.jpg"/></p><p style="text-align: center"><img src="http://www.lavin.com.cn/data/upload/ueditor/20180906/5b914d0052ab7.jpg" style="" title="WechatIMG38.jpg"/></p><p><br/></p><p><br/></p><p><br/></p>', '心之芳庭', '经典法式宫殿设计，高大通透的宴会空间，独具风格的挑高穹顶，配有经典复古的水晶吊灯。百万级定光音响设备，呈现梦幻多彩的光影视听盛宴。超大弧形LED大屏幕，丰富商务活动立体体验。', 1, 1, '2018-08-27 13:19:06', NULL, 0, NULL, '', 0, '{"thumb":"20180906\\/5b914c3b9bce1.jpg"}', 21, 0, 0, 0, 0, '2018-08-27 13:19:06', '2018-08-27 13:19:06', '北京·太阳公元', '商务', '380', '9米', '18桌', '大厅无柱  P3LED屏', '2018年档期免收服务费', '85000元'),
...
(136, 1, '', NULL, '2018-09-10 09:55:05', '', '商务-》一站式服务', '', 1, 1, '2018-09-10 09:54:44', NULL, 0, 2, '', 0, '{"template":"page-yzsfw","thumb":""}', 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, '0', '0', '0', NULL, NULL, NULL),
(137, 1, '', NULL, '2018-09-10 10:23:33', '', '商务-》服务团队', '', 1, 1, '2018-09-10 10:23:24', NULL, 0, 2, '', 0, '{"template":"page","thumb":""}', 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, '0', '0', '0', NULL, NULL, NULL),
(138, 1, '', '', '2018-09-11 11:15:17', '<p><video class="edui-upload-video  vjs-default-skin   video-js" controls="" preload="none" width="420" height="280" src="http://www.lavin.com.cn/data/upload/ueditor/20180911/5b972fd192aa0.mp4" data-setup="{}"><source src="http://www.lavin.com.cn/data/upload/ueditor/20180911/5b972fd192aa0.mp4" type="video/mp4"/></video></p>', '云间有你', '幸福源于今生遇见了你！相知相爱，相守一辈子！', 1, 1, '2018-09-11 10:59:28', NULL, 0, NULL, '', 0, '{"thumb":"20180911\\/5b97387b335a8.jpg"}', 6, 0, 0, 0, 0, '2018-09-11 10:59:28', '2018-09-11 10:59:28', '北京·太阳公元', '婚礼', '', '', '', '', '', '');
...
(5, 2, '上海外滩', '/data/upload/20180905/5b8f819d3c6a5.jpeg', '', '', '', 1, 3),
(6, 3, '天津爱琴海', '/data/upload/20180905/5b8f820037d55.jpeg', '', '', '', 1, 4),
(7, 4, '南京外秦淮', '/data/upload/20180905/5b8f824ba815e.jpeg', '', '', '', 1, 5),
(8, 5, '南京1865', '/data/upload/20180905/5b8f8270d6ae0.jpeg', '', '', '', 1, 6),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='幻灯片分类表' AUTO_INCREMENT=11 ;
...
(1, '婚礼-北京', 'mgl-banner', '婚庆和商务的首页、一站式服务、婚宴报价、关于玫瑰里公共幻灯', 1),
(2, '婚礼-上海', 'sh-banner', '', 1),
(3, '婚礼-天津', 'tj-banner', '', 1),
(4, '婚礼-南京·外秦淮', 'njwq-banner', '', 1),
(5, '婚礼-南京·1865', 'nj-banner', '', 1),
(6, '商务-北京', 'sw-mgl-banner', '', 1),
(7, '商务-上海', 'sw-sh-banner', '', 1),
(8, '商务-天津', 'sw-tj-banner', '', 1),
(9, '商务-南京·外秦淮', 'sw-njwq-banner', '', 1),
(10, '商务-南京·1865', 'sw-nj-banner', '', 1);

-- --------------------------------------------------------

--
-- 表的结构 `data_slide_cat_bak`
--

CREATE TABLE IF NOT EXISTS `data_slide_cat_bak` (
  `cid` int(11) NOT NULL AUTO_INCREMENT,
  `cat_name` varchar(255) NOT NULL COMMENT '幻灯片分类',
  `cat_idname` varchar(255) NOT NULL COMMENT '幻灯片分类标识',
  `cat_remark` text COMMENT '分类备注',
...
--
-- 转存表中的数据 `data_slide_cat_bak`
--

INSERT INTO `data_slide_cat_bak` (`cid`, `cat_name`, `cat_idname`, `cat_remark`, `cat_status`) VALUES
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Portal 文章分类对应表' AUTO_INCREMENT=137 ;
...
(1, 'admin', '###860d4a9905843a85391d8d05adef5748', 'admin', 'mindasiy@sina.com', '', NULL, 0, NULL, NULL, '106.39.79.210', '2018-09-13 14:46:46', '2018-04-23 12:52:27', '', 1, 0, 1, 0, ''),
...
(9, '', '###860d4a9905843a85391d8d05adef5748', 'test', 'test@test.com', '', NULL, 0, NULL, NULL, '60.217.194.170', '2018-09-13 15:38:23', '2000-01-01 00:00:00', '', 1, 0, 1, 0, '15098800372');
