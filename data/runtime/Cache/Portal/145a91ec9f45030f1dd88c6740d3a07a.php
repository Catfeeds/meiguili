...
<div class="mgl-hlbj">
	<ul>
		<?php $_result=SidTypes(4);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($vo["label"] == $post_title): ?>class="active"<?php endif; ?>><a href="<?php echo ($vo["href"]); ?>" ><?php echo ($vo["label"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>

	</ul>
</div>
<div id="article_cptl_content">
	<style>
		#cptl-swiper .swiper-slide img{
			width: 100%;
			display: block;
		}
	</style>
<div class="swiper-container" id="cptl-swiper">
...
<!-- Le javascript
 ...
 <script>
	 $('.swiper-wrapper').each(function () {
		 $(this).find('p').addClass('swiper-slide');
     })
     var swiper = new Swiper('#cptl-swiper', {
         slidesPerView: 4,
         spaceBetween: 30,
