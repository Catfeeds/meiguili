...
<!--<div class="tran-index-banner-icon clear">-->
<!--&lt;!&ndash;<h1>玫瑰里文化时尚平台</h1>&ndash;&gt;-->
<!--<a href="<?php echo U('index/main');?>"><img src="/images/transtion-index-icon-01.png"></a>-->
<!--<a href="<?php echo U('index/swmain');?>"><img src="/images/transtion-index-icon-02.png"></a>-->
<!--</div>-->
<div class="tran-index-banner-icon clear">
	<!--<h1>玫瑰里文化时尚平台</h1>-->
	<a href="<?php echo U('index/main');?>" style="margin-left:20px; margin-right: -20px;"><img src="/images/transtion-index-icon-01.png"></a>
	<a href="<?php echo U('index/swmain');?>" style="margin-left: -20px;"><img src="/images/transtion-index-icon-02.png"></a>
</div>
