...
<div class="w1200 mtb50 clear anli-xiaozhi">
 <div class="list-title-dsj"><?php echo ($post_title); ?></div>
 <div class="act-tips-dsj">
 <p><img src="/images/act-icons_01.png">发布时间:<?php echo date('Y/m/d',strtotime($post_date));?></p>
<p><img src="/images/act-icons_05.png">浏览次数:<span class="red"><?php echo ($post_hits); ?></span>次</p>
</div>
...
<div class="anli-btngroups">
	<a href="/index.php?m=list&a=index&id=<?php echo ($term_id); ?>">返回列表</a>
</div>
 	<div class="clear"></div>
