...
#activity-con,#huili-con{display: none;}
</style>
</head>
<body>
	<div class="wrap js-check-wrap">
		...
		<form action="<?php echo U('AdminPost/add_post');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			<div class="row-fluid">
				<div class="span9">
				<?php $getaddress=sp_getaddress(); ?>
					<table class="table table-bordered">
					<tr>
							<th width="80">地址</th>
							<td>
							<select style="max-height: 100px;" name="post[postadderss]"> 
							<?php if(is_array($getaddress)): foreach($getaddress as $key=>$vo): ?><option value="<?php echo ($vo["address"]); ?>"><?php echo ($vo["address"]); ?></option><?php endforeach; endif; ?>
							 </select> 					 
							</td>
							...
							<th width="80">类型</th>
							<td>
							<select style="max-height: 100px;" name="post[type]">
						...
						<tr>
							<th width="80">栏目</th>
							<td>
								<select id="selectListname" multiple="multiple" style="max-height: 100px;" name="term[]"><?php echo ($taxonomys); ?></select>
						...
						<tr id="activity-con">
							<th>活动时间</th>
							<td>
								开始时间:<input type="text" name="post[actstarttime]" value="<?php echo date('Y-m-d H:i:s',time());?>" class="js-datetime" style="width: 160px;">
								结束时间:<input type="text" name="post[actendtime]" value="<?php echo date('Y-m-d H:i:s',time());?>" class="js-datetime" style="width: 160px;">
							</td>
						</tr>
							<tr id="huili-con">
							<th>婚礼场馆</th>
							<td>
								最大容纳:<input type="text" name="post[max]" value=""  style="width: 60px;">
								厅高:<input type="text" name="post[tinggao]" value=""  style="width: 60px;">
								起订桌数:<input type="text" name="post[zhuoshu]" value=""  style="width: 60px;">
								特色:<input type="text" name="post[tese]" value=""  style="width: 60px;">
								优惠:<input type="text" name="post[youhui]" value=""  style="width: 60px;">
								场地价格:<input type="text" name="post[jiage]" value=""  style="width: 60px;">
							</td>
						</tr>
						<tr>
							<th>关键词</th>
	...
	<script type="text/javascript">
		$(function() {
			$("#selectListname").on('change', function(e){
