...
<div class="list-title">玫瑰里实时活动</div>
	<div class="list-activity">
				<?php if($_SESSION["mainnav"]==2){ $lists = sp_sql_posts_paged("cid:$cat_id;order:post_date DESC;where:type='商务' and postadderss='$address'",5); }else{ $lists = sp_sql_posts_paged("cid:$cat_id;order:post_date DESC;where:type='婚礼' and postadderss='$address'",5); } ?>
				...
				<div class="list-act-r">
					...
					<p><img src="/images/act-icons_01.png">活动时间:<?php echo date('Y/m/d',strtotime($vo['actstarttime']));?>-<?php echo date('Y/m/d',strtotime($vo['actendtime']));?></p>
  ...
  <?php if($datatime < $starttime): ?><span class="color2">活动未开始</span>
					...
					<a href="<?php echo leuu('article/index',array('id'=>$vo['tid'],'cid'=>$vo['term_id']));?>"><span class="color1">活动报名中</span>
					</a>
					<?php else: ?>
