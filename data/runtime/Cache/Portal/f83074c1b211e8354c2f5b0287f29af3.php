...
<div class="index-title">
    商务实录<a href="/index.php?m=list&a=index&id=15">查看更多>></a>
</div>
<div class="index-hlsl clear">
    <div class="swiper-container" id="hlsl-swiper">
        <div class="swiper-wrapper">
            <ul class="swiper-slide">
                <?php $lists = sp_sql_posts_paged_index("cid:15;order:post_date
            ...
            <ul class="swiper-slide">
                <?php $lists = sp_sql_posts_paged_index("cid:15;order:post_date
                    DESC;limit:2,3;where:postadderss='$address'",1); ?>
                <?php if(is_array($lists['posts'])): $i = 0; $__LIST__ = $lists['posts'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; $smeta=json_decode($vo['smeta'], true); ?>
                    <li>
                        <div class="aimg">
                            <a href="<?php echo leuu('article/index',array('id'=>$vo['tid'],'cid'=>$vo['term_id']));?>">
