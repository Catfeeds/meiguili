...
<div class="list-title">玫瑰里实时活动</div>
	<div class="list-activity clear">
				<?php if($_SESSION["mainnav"]==2){ $lists = sp_sql_posts_paged("cid:$cat_id;order:post_date DESC;where:type='商务'",5); }else{ $lists = sp_sql_posts_paged("cid:$cat_id;order:post_date DESC;where:type='婚礼'",5); } ?>
