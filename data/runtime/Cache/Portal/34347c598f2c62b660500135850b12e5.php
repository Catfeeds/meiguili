...
<div class="w1200 mtb50 clear">
    ...
    <div class="anlist-con clear">
        <ul>
            <?php $lists = sp_sql_posts_paged("cid:$cat_id;order:listorder DESC;where:postadderss='$address'",5); ?>
                ...
                <li>
                    <div class="allist-l">
                        ...
                        <div class="list-anli-img">
                            <?php if(!empty($smeta['thumb'])): ?><a href="<?php echo leuu('article/index',array('id'=>$vo['tid'],'cid'=>$vo['term_id']));?>"><img
                                        src="<?php echo sp_get_asset_upload_path($smeta['thumb']);?>" alt="<?php echo ($vo["post_title"]); ?>">
                                </a>
                                <?php else: endif; ?>
                        </div>
