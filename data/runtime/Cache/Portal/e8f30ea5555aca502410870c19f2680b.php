...
<ul class="sublist_title">
				<?php $_result=findsnav(8);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($vo["label"] == $post_title): ?>class="active"<?php endif; ?>><a href="<?php echo ($vo["href"]); ?>" ><?php echo ($vo["label"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
		    </ul>
</div>
