...
<div class="arc-anli-title"><?php echo ($post_title); ?></div>
 <div class="act-text   clear">
 <span class="text"><img src="/images/act-icons_01.png">发表时间:<?php echo date('Y/m/d ',strtotime($post_date));?></span>
<span class="text"><img src="/images/act-icon10.png" style="width:17px">浏览次数:<span class="red"><?php echo ($post_hits); ?></span>人</span>
