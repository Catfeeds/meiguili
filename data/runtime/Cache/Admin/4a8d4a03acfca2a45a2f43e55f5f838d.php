...
<body>
	<div class="wrap js-check-wrap">
		...
		<!-- 	<li><a href="#C" data-toggle="tab"><?php echo L('URL_SETTING');?></a></li>
			...
			<li><a href="#G" data-toggle="tab">各城市客服代码添加</a></li>
		</ul>
				...
				<div class="tabbable">
					<div class="tab-content">
						...
						<div class="tab-pane" id="G">
							<fieldset>
								<div class="control-group">
									<label class="control-label">北京客服：</label>
									<div class="controls">
										<textarea name="options[site_bj_kf]" rows="5" cols="57"><?php echo ($site_bj_kf); ?></textarea>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">上海客服：</label>
									<div class="controls">
										<textarea name="options[site_sh_kf]" rows="5" cols="57"><?php echo ($site_sh_kf); ?></textarea>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">天津客服:</label>
									<div class="controls">
										<textarea name="options[site_tj_kf]" rows="5" cols="57"><?php echo ($site_tj_kf); ?></textarea>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">南京·外秦淮客服:</label>
									<div class="controls">
										<textarea name="options[site_njwq_kf]" rows="5" cols="57"><?php echo ($site_njwq_kf); ?></textarea>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">南京·1865客服:</label>
									<div class="controls">
										<textarea name="options[site_nj_kf]" rows="5" cols="57"><?php echo ($site_nj_kf); ?></textarea>
									</div>
								</div>
							</fieldset>
						</div>
